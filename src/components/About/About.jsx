...
const About = () => {
  return (
    <section id='about' className='mb-40 px-5 sm:px-10 md:px-20 '>
        ...
        <div className='relative flex flex-col-reverse lg:flex-row justify-between items-start'>
...
<pre className="max-w-[100vw] sm:max-w-auto overflow-hidden absolute left-0 top-0 p-4 text-accent-default">
  <code>
    <div>
      <span style={{ color: '#6c757d' }}>1. </span>
      <span style={{ color: '#ff5555' }}>&lt;!DOCTYPE html&gt;</span>
    </div>
    <div>
      <span style={{ color: '#6c757d' }}>2. </span>
      <span style={{ color: '#bd93f9' }}>&lt;html&gt;</span>
    </div>
    <div>
      <span style={{ color: '#6c757d' }}>3. </span>
      <span style={{ color: '#bd93f9' }}>&nbsp;&nbsp;&lt;head&gt;</span>
    </div>
    <div>
    ...
    <div>
      ...
      <span style={{ color: '#bd93f9' }}>&nbsp;&nbsp;&lt;body&gt;</span>
    </div>
    <div>
