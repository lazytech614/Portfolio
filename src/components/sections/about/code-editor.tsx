...
const CodeEditor = ({ loadingDone = true }: CodeEditorProps) => {
  const codeLines = [
    ...
    { number: 3, content: '<span class="text-gray-500">&lt;</span><span class="text-red-400">head</span><span class="text-gray-500">&gt;</span>', indent: 1 },
    { number: 4, content: '<span class="text-gray-500">&lt;</span><span class="text-green-400">title</span><span class="text-gray-500">&gt;</span><span class="text-white">Full Stack Developer</span><span class="text-gray-500">&lt;/</span><span class="text-green-400">title</span><span class="text-gray-500">&gt;</span>', indent: 2 },
    ...
    { number: 8, content: '<span class="text-gray-500">&lt;</span><span class="text-green-400">p</span><span class="text-gray-500">&gt;</span><span class="text-white">Passionate web developer specializing in React & Next.js</span><span class="text-gray-500">&lt;/</span><span class="text-green-400">p</span><span class="text-gray-500">&gt;</span>', indent: 2 },
    ...
    { number: 11, content: '<span class="text-white">Backend: NodeJS, Express</span>', indent: 3 },
    { number: 12, content: '<span class="text-white">Styling: Tailwind CSS, Framer Motion</span>', indent: 3 },
    { number: 13, content: '<span class="text-gray-500">&lt;/</span><span class="text-green-400">div</span><span class="text-gray-500">&gt;</span>', indent: 2 },
    { number: 14, content: '<span class="text-gray-500">&lt;/</span><span class="text-red-400">body</span><span class="text-gray-500">&gt;</span>', indent: 1 },
    { number: 15, content: '<span class="text-gray-500">&lt;/</span><span class="text-red-400">html</span><span class="text-gray-500">&gt;</span>' },
  ];
