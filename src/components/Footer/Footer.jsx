  ...
  return (
    <footer className='mt-10 mb-6 px-5 sm:px-10 md:px-20'>
        <div className='flex justify-between items-center'>
            <div>
                <p className='text-[24px] sm:text-[32px] font-semibold mb-4'>Rupanjan De</p>
                <p className='text-[12px] md:text-[14px]'><span className='text-accent-default capitalize'>Full stack web developer</span> from Roorkee, Uttarakhand</p>
            </div>
        ...
        <div className='flex justify-between items-center'>
            <div className='text-[#d9d9d9] text-[8px] sm:text-[10px] flex sm:gap-2'>
                <img className='w-[8px] sm:w-[10px]' src={copyright} alt='copyright' />
                2024 Rupanjan De. All rights reserved.
            </div>
